...
<form action="" method="post">
  ...
  <div class="mb-3">
        ...
        <input type="text" class="form-control" id="exampleInputPassword1" name="nis" value="<?= $student["nis"]?>">
        </div>
  <div class="mb-3">
        <label for="exampleInputPassword1" class="form-label">Rayon</label>
        <input type="text" class="form-control" id="exampleInputPassword1" name="rombel" value="<?= $student["rayon"]?>">
        </div>
  <div class="mb-3">
        <label for="exampleInputPassword1" class="form-label">Rombel</label>
        <input type="text" class="form-control" id="exampleInputPassword1" name="rayon" value="<?= $student["rombel"]?>">
        </div>
  <div class="mb-3">
        <label for="exampleInputPassword1" class="form-label">Status</label>
        <input type="text" class="form-control" id="exampleInputPassword1" name="status" value="<?= $student["status"]?>">
        </div>
  <div class="mb-3">
